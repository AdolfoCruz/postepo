...
var KTDatatablesButtons = function () {
    ...
    var initDatatable = function () {
        ...
        dt = $("#categories_datatable").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: false,
            order: [[0, 'asc']],
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="${HOST_URL}/category/editar/${row.id}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                                        Editar
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-docs-table-filter="delete_row" data-category-id="${row.id}">
                                        Eliminar
                                    </a>
                                </div>
                                <!--end::Menu item-->
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: "Estas seguro de querer eliminar la categoria " + productName + "?",
                    icon: "warning",
