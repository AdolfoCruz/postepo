                        ...
                        <form id="kt_ecommerce_settings_general_store" class="form" action="#">
                            ...
                            <div class="row fv-row mb-7">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        <span class="required">Nombre de la tienda</span>
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Ingresa el nombre que aparecerá en los tickets"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row fv-row mb-7">
                                <div class="col-md-3 text-md-end">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        <span class="required">Dueño de la tienda</span>
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Nombre completo del dueño de la tienda"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row fv-row mb-7">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Dirección que aparecerá en los tickets"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
