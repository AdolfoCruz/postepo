        ...
        <div class="card card-flush">
            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="myTabContent" data-select2-id="select2-data-myTabContent">
                    <!--begin:::Tab pane-->
                    <div class="tab-pane fade active show" id="kt_ecommerce_settings_general" role="tabpanel" data-select2-id="select2-data-kt_ecommerce_settings_general">
                        <!--begin::Form-->
...
​
                            ...
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="row fv-row mb-7" data-select2-id="select2-data-150-vysy">
                                <div class="col-md-3 text-md-end">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        <span>Theme</span>
                                ...
                                <div class="col-md-9" data-select2-id="select2-data-149-3aou">
                                    <div class="w-100" data-select2-id="select2-data-148-w57a">
                                        <!--begin::Select2-->
                                        <select class="form-select form-select-solid select2-hidden-accessible" name="theme" data-control="select2" data-hide-search="true" data-placeholder="Select a layout" data-select2-id="select2-data-7-o0qp" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                            <option data-select2-id="select2-data-152-uojf"></option>
                                            <option value="Default" selected="selected" data-select2-id="select2-data-9-xelh">Default</option>
                                            <option value="Minimalist" data-select2-id="select2-data-153-agj4">Minimalist</option>
                                            <option value="Dark" data-select2-id="select2-data-154-iw5s">Dark</option>
                                            <option value="High_Contrast" data-select2-id="select2-data-155-cprd">High Contrast</option>
                                        </select><span class="select2 select2-container select2-container--bootstrap5 select2-container--below" dir="ltr" data-select2-id="select2-data-8-wcit" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-theme-s6-container" aria-controls="select2-theme-s6-container"><span class="select2-selection__rendered" id="select2-theme-s6-container" role="textbox" aria-readonly="true" title="Default">Default</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        <!--end::Select2-->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row fv-row mb-7">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Set default layout style for the store." data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                                    <div class="w-100">
                                        <!--begin::Select2-->
                                        <select class="form-select form-select-solid select2-hidden-accessible" name="layout" data-control="select2" data-hide-search="true" data-placeholder="Select a layout" data-select2-id="select2-data-10-o7nk" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                            <option></option>
                                            <option value="Default" selected="selected" data-select2-id="select2-data-12-dix8">Default</option>
                                            <option value="Electronics">Electronics</option>
                                            <option value="Fashion">Fashion</option>
                                            <option value="Home">Home</option>
                                            <option value="Dining">Dining</option>
                                            <option value="Interior">Interior</option>
                                        </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-11-sdte" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-layout-jb-container" aria-controls="select2-layout-jb-container"><span class="select2-selection__rendered" id="select2-layout-jb-container" role="textbox" aria-readonly="true" title="Default">Default</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        <!--end::Select2-->
                                    </div>
                                </div>
                            </div>
                        ...
                        <form id="kt_ecommerce_settings_general_store" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                            ...
                            <div class="row fv-row mb-7 fv-plugins-icon-container">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Set the name of the store" data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row fv-row mb-7 fv-plugins-icon-container">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Set the store owner's name" data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row fv-row mb-7 fv-plugins-icon-container">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Set the store's full address." data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row fv-row mb-7">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        <span>Geocode</span>
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Enter the store geocode manually (optional)" data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                        ...
                        <form id="kt_ecommerce_settings_general_localization" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                            ...
                            <div class="row fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select id="kt_ecommerce_localization_country" class="form-select form-select-solid select2-hidden-accessible" name="localization_country" data-kt-ecommerce-settings-type="select2_flags" data-placeholder="Select a country" data-select2-id="select2-data-kt_ecommerce_localization_country" tabindex="-1" aria-hidden="true">
                                        <option data-select2-id="select2-data-146-te7y"></option>
                            ...
                            <div class="row fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        <!--begin::Select2-->
                                        <select class="form-select form-select-solid select2-hidden-accessible" name="localization_language" data-control="select2" data-placeholder="Select a language" data-select2-id="select2-data-13-ic42" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                            <option data-select2-id="select2-data-15-1nu7"></option>
                                        ...
                                        </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-14-489t" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-localization_language-za-container" aria-controls="select2-localization_language-za-container"><span class="select2-selection__rendered" id="select2-localization_language-za-container" role="textbox" aria-readonly="true" title="Select a language"><span class="select2-selection__placeholder">Select a language</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        <!--end::Select2-->
                                    </div>
                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            </div>
                            ...
                            <div class="row fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        <!--begin::Select2-->
                                        <select class="form-select form-select-solid select2-hidden-accessible" name="localization_currency" data-control="select2" data-hide-search="true" data-placeholder="Select a currency" data-select2-id="select2-data-16-phpy" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                            <option data-select2-id="select2-data-18-9d8y"></option>
                                        ...
                                        </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-17-xll1" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-localization_currency-87-container" aria-controls="select2-localization_currency-87-container"><span class="select2-selection__rendered" id="select2-localization_currency-87-container" role="textbox" aria-readonly="true" title="Select a currency"><span class="select2-selection__placeholder">Select a currency</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        <!--end::Select2-->
                                    </div>
                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            </div>
                            ...
                            <div class="row fv-row mb-7 fv-plugins-icon-container">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Set the unit measurement for length." data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                                    <div class="w-100">
                                        <!--begin::Select2-->
                                        <select class="form-select form-select-solid select2-hidden-accessible" name="localization_currency" data-control="select2" data-hide-search="true" data-placeholder="Select a length class" data-select2-id="select2-data-19-96cb" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                            <option></option>
                                            <option value="cm" selected="selected" data-select2-id="select2-data-21-6ujo">Centimeter</option>
                                            <option value="mm">Milimeter</option>
                                            <option value="in">Inch</option>
                                        </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-20-28wf" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-localization_currency-5p-container" aria-controls="select2-localization_currency-5p-container"><span class="select2-selection__rendered" id="select2-localization_currency-5p-container" role="textbox" aria-readonly="true" title="Centimeter">Centimeter</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        <!--end::Select2-->
                                    </div>
                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            </div>
                            ...
                            <div class="row fv-row mb-7 fv-plugins-icon-container">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Set the unit measurement for weight." data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                                    <div class="w-100">
                                        <!--begin::Select2-->
                                        <select class="form-select form-select-solid select2-hidden-accessible" name="localization_currency" data-control="select2" data-hide-search="true" data-placeholder="Select a weight class" data-select2-id="select2-data-22-un9u" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                            <option></option>
                                            <option value="kg" selected="selected" data-select2-id="select2-data-24-82xm">Kilogram</option>
                                            <option value="g">Gram</option>
                                            <option value="lb">Pound</option>
                                            <option value="oz">Ounce</option>
                                        </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-23-bt0x" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-localization_currency-rf-container" aria-controls="select2-localization_currency-rf-container"><span class="select2-selection__rendered" id="select2-localization_currency-rf-container" role="textbox" aria-readonly="true" title="Kilogram">Kilogram</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        <!--end::Select2-->
                                    </div>
                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            </div>
                            ...
                            <div class="row fv-row mb-7">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Enable/disable review entries for registered customers" data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row fv-row mb-16">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Enable/disable review entries for public guest customers" data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row fv-row mb-7 fv-plugins-icon-container">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Minimum number of vouchers customers can attach to an order" data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row fv-row mb-16 fv-plugins-icon-container">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Maximum number of vouchers customers can attach to an order" data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row fv-row mb-7 fv-plugins-icon-container">
                                <div class="col-md-3 text-md-end">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Determines the tax percentage (%) applied to orders" data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                </div>
                                <div class="col-md-9">
