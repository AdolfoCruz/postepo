                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/index.html" class="menu-link active">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/ecommerce.html" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/projects.html" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/online-courses.html" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/marketing.html" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/bidding.html" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/pos.html" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/call-center.html" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                            ...
                                            <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                                                ...
                                                <a href="../../demo6/dist/landing.html" class="btn btn-sm btn-primary fw-bold">Explore</a>
                                            </div>
                                            <!--end:Landing-->
                                        </div>
                                        <!--end:Col-->
                                        ...
                                        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/logistics.html" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/website-analytics.html" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/finance-performance.html" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/store-analytics.html" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/social.html" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/delivery.html" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/crypto.html" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/school.html" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/podcast.html" class="menu-link py-2">
                                    ...
                                    <div class="tab-content py-4 py-lg-8 px-lg-7">
                                        ...
                                        <div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/pages/user-profile/overview.html" class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/pages/user-profile/projects.html" class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/pages/user-profile/campaigns.html" class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/pages/user-profile/documents.html" class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/pages/user-profile/followers.html" class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/pages/user-profile/activity.html" class="menu-link">
                                                        ...
                                                        <div class="col-lg-3 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/about.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/team.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/contact.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/licenses.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/sitemap.html" class="menu-link">
                                                            ...
                                                            <div class="mb-0">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/careers/list.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/careers/apply.html" class="menu-link">
                                                        ...
                                                        <div class="col-lg-3 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/faq/classic.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/faq/extended.html" class="menu-link">
                                                            ...
                                                            <div class="mb-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/blog/home.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/blog/post.html" class="menu-link">
                                                            ...
                                                            <div class="mb-0">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/pricing/column.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/pricing/table.html" class="menu-link">
                                                        ...
                                                        <div class="col-lg-3 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-0">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/social/feeds.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/social/activity.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/social/followers.html" class="menu-link">
                                                                        <span class="menu-title">Followers</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/pages/social/settings.html" class="menu-link">
                                                ...
                                                <!--begin:Col-->
                                                <div class="col-lg-4">
                                                    <img src="{{ asset('metronic/assets/media/stock/600x600/img-82.jpg') }}" class="rounded mw-100" alt="" />
                                                </div>
                                                <!--end:Col-->
                                            </div>
                                            <!--end:Row-->
                                                ...
                                                <div class="col-lg-5 mb-6 mb-lg-0">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/account/overview.html" class="menu-link">
                                                                    <span class="menu-title">Overview</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/account/settings.html" class="menu-link">
                                                                    <span class="menu-title">Settings</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/account/security.html" class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/account/activity.html" class="menu-link">
                                                                    <span class="menu-title">Activity</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/account/billing.html" class="menu-link">
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/account/statements.html" class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/account/referrals.html" class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/account/api-keys.html" class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo6/dist/account/logs.html" class="menu-link">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 mb-6 mb-lg-0">
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/corporate/sign-in.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/corporate/sign-up.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/corporate/two-steps.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/corporate/reset-password.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/corporate/new-password.html" class="menu-link">
                                                    ...
                                                    <div class="mb-0">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/overlay/sign-in.html" class="menu-link">
                                                                <span class="menu-title">Sign-in</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/overlay/sign-up.html" class="menu-link">
                                                                <span class="menu-title">Sign-up</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/overlay/two-steps.html" class="menu-link">
                                                                <span class="menu-title">Two-steps</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/overlay/reset-password.html" class="menu-link">
                                                                <span class="menu-title">Reset Password</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/overlay/new-password.html" class="menu-link">
                                                                <span class="menu-title">New Password</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                ...
                                                <div class="col-lg-3 mb-6 mb-lg-0">
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/creative/sign-in.html" class="menu-link">
                                                                <span class="menu-title">Sign-in</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/creative/sign-up.html" class="menu-link">
                                                                <span class="menu-title">Sign-up</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/creative/two-steps.html" class="menu-link">
                                                                <span class="menu-title">Two-steps</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/creative/reset-password.html" class="menu-link">
                                                                <span class="menu-title">Reset Password</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/creative/new-password.html" class="menu-link">
                                                                <span class="menu-title">New Password</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/fancy/sign-in.html" class="menu-link">
                                                                <span class="menu-title">Sign-in</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/fancy/sign-up.html" class="menu-link">
                                                                <span class="menu-title">Sign-up</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/fancy/two-steps.html" class="menu-link">
                                                                <span class="menu-title">Two-steps</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/fancy/reset-password.html" class="menu-link">
                                                                <span class="menu-title">Reset Password</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/layouts/fancy/new-password.html" class="menu-link">
                                                                <span class="menu-title">New Password</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                ...
                                                <div class="col-lg-3 mb-6 mb-lg-0">
                                                    ...
                                                    <div class="mb-0">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/extended/multi-steps-sign-up.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/extended/two-factor-auth.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/general/welcome.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/general/verify-email.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/extended/coming-soon.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/general/password-confirmation.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/general/account-deactivated.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/general/error-404.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/general/error-500.html" class="menu-link">
                                                ...
                                                <div class="col-lg-3 mb-6 mb-lg-0">
                                                    ...
                                                    <div class="mb-0">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/email/verify-email.html" class="menu-link">
                                                                <span class="menu-title">Verify Email</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/email/invitation.html" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/email/password-reset.html" class="menu-link">
                                                                <span class="menu-title">Reset Password</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo6/dist/authentication/email/password-change.html" class="menu-link">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-0">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/general/invite-friends.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/general/view-users.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/general/select-users.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/general/upgrade-plan.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/general/share-earn.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/forms/new-target.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/forms/new-card.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/forms/new-address.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/forms/create-api-key.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/forms/bidding.html" class="menu-link">
                                                        ...
                                                        <div class="col-lg-4 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/wizards/create-app.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/wizards/create-campaign.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/wizards/create-account.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/wizards/create-project.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/wizards/top-up-wallet.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/wizards/offer-a-deal.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/wizards/two-factor-authentication.html" class="menu-link">
                                                                        <span class="menu-title">Two Factor Auth</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            ...
                                                            <div class="mb-0">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/search/horizontal.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/search/vertical.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/search/users.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/modals/search/select-location.html" class="menu-link">
                                                        ...
                                                        <div class="col-lg-4 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-0">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/wizards/horizontal.html" class="menu-link">
                                                                        <span class="menu-title">Horizontal</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/wizards/vertical.html" class="menu-link">
                                                                        <span class="menu-title">Vertical</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/wizards/two-factor-authentication.html" class="menu-link">
                                                                        <span class="menu-title">Two Factor Auth</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/wizards/create-app.html" class="menu-link">
                                                                        <span class="menu-title">Create App</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/wizards/create-campaign.html" class="menu-link">
                                                                        <span class="menu-title">Create Campaign</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/wizards/create-account.html" class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/wizards/create-project.html" class="menu-link">
                                                                        <span class="menu-title">Create Project</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo6/dist/utilities/wizards/offer-a-deal.html" class="menu-link">
                                                                        <span class="menu-title">Offer a Deal</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                        ...
                                        <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 mb-6 mb-lg-0">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/widgets/lists.html" class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/widgets/statistics.html" class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/widgets/charts.html" class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/widgets/mixed.html" class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/widgets/tables.html" class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/widgets/feeds.html" class="menu-link">
                                                            <span class="menu-title">Feeds</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    </div>
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/projects/list.html">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/projects/project.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/projects/targets.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/projects/budget.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/projects/users.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Users</span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/projects/files.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/projects/activity.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Activity</span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/projects/settings.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Settings</span>
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/catalog/products.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/catalog/categories.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/catalog/add-product.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/catalog/add-category.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/catalog/edit-category.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/sales/listing.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/sales/details.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/sales/add-order.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/sales/edit-order.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion menu-sub-indention">
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/customers/listing.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/customers/details.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion menu-sub-indention">
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/reports/view.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/reports/sales.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Sales</span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/reports/returns.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/reports/customer-orders.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/reports/shipping.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/ecommerce/settings.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Settings</span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/contacts/getting-started.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/contacts/add-contact.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/contacts/edit-contact.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="../../demo6/dist/apps/contacts/view-contact.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link py-3" href="../../demo6/dist/apps/invoices/view/invoice-3.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link py-3" href="../../demo6/dist/apps/calendar.html">
                                        <span class="menu-icon">
                                            <i class="bi bi-calendar3-event fs-3"></i>
                                        </span>
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                        ...
                        <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ asset('metronic/assets/media/avatars/300-6.jpg') }}" alt="" />
                            ...
                            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <a href="../../demo6/dist/pages/search/horizontal.html" class="btn btn-sm fw-bold btn-primary" data-kt-search-element="advanced-options-form-search">Search</a>
                                </div>
                                <!--end::Actions-->
                            </form>
                            <!--end::Preferences-->
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        ...
                        <img src="{{ asset('metronic/assets/media/avatars/300-1.jpg') }}" alt="image" />
                    </div>
